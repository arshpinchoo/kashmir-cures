...
function openProductManager(){renderProductEditor();productManager.classList.add('open');productManagerOverlay.classList.add('open');productManager.setAttribute('aria-hidden','false');document.body.style.overflow='hidden'}
function closeProductManager(){productManager.classList.remove('open');productManagerOverlay.classList.remove('open');productManager.setAttribute('aria-hidden','true');document.body.style.overflow=''}
